...
/**
 * ContactSection exibe um formulário de contato estilizado e um carrossel de imagens no lugar do Google Maps.
 */
  ...
  return (
    <section id="contato" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="bg-[#F5F5F5] rounded-xl shadow-lg p-8 h-full flex flex-col justify-between">
          <div>
            <img
